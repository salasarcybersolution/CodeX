  ...
  <div class="card-datatable table-responsive">
       <table id="example" class="table table-striped">
        ...
        <tbody>
          ...
          ?>
            <tr>
                <td onclick="window.location='<?php echo $urls; ?>';" width="150"><?php echo $row->entrustedDate; ?>
                  <?php
                   if($row->report_type == 1){
                   echo '<span class="badge rounded-pill bg-label-danger">Spot</span>';
                   }elseif($row->report_type == 2){
                    echo '<span class="badge rounded-pill bg-label-warning">Interim</span>';
                   }elseif($row->report_type == 3){
                ...
                <td onclick="window.location='<?php echo $urls; ?>';"><?php echo $row->insurer; ?></td>
