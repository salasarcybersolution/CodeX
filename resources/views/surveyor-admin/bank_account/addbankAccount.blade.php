                        ...
                        <div class="row g-3">
                           ...
                           <div class="col-md-6">
                              <div class="field">
                                 ...
                                 <input type="text" name="micr" id="micr" class="form-control" required>
                           ...
                           <div class="col-md-6">
                              <div class="field">
                                 ...
                                 <input type="email" name="bank_email" id="bank_email" class="form-control" required>
                           ...
                           <div class="col-md-6">
                              <div class="field">
                                 ...
                                 <input type="text" name="contact_person_mobile" id="contact_person_mobile" class="form-control" required>
                           ...
                           <div class="col-md-6">
                              <div class="field">
                                 ...
                                 <input type="text" name="contact_person_designation" id="contact_person_designation" class="form-control" required>
