                  ...
                  <div class="card-body">
                     <div class="tab-content p-0">
                        <div class="tab-pane fade show active" id="navs-pills-within-card-active" role="tabpanel">
                           <form class="needs-validation" novalidate id="registrationFormFinal" action="{{url('SpotReport/saveSurveyInfo')}}" method="POST">
                           	@csrf
                              <div class="accordion mt-3" id="accordionExample">
                                          ...
                                          <div class="row mt-4" id="list_tab_content_1">
                                              <div class="col-md-12 col-lg-3">
	    													<div class="mb-3 field">
	    														...
	    														<input type="date" class="form-control" id="date_of_accident"  name="date_of_accident" value="@if(isset($surveyDetails->date_of_accident)){{$surveyDetails->date_of_accident}}@endif" required>
	    												...
	    												<div class="col-md-12 col-lg-3">
	    													<div class="mb-3 field">
	    														...
	    														<input type="time" class="form-control" id="time_of_accident"  name="time_of_accident" value="@if(isset($surveyDetails->time_of_accident)){{$surveyDetails->time_of_accident}}@endif">
                                 ...
                                 <div class="card accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                       <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionTwo" aria-expanded="false" aria-controls="accordionTwo"> Suevy Receipt  Details <i class="fa fa-check-circle custom_css mx-1" aria-hidden="true"></i>
                                       </button>
                                    </h2>
                                             	...
                                             	<div class="col-md-12 col-lg-4">
			    												...
			    												<div class="col-md-12 col-lg-4">
			    													<div class="mb-3 field">
			    														...
			    														<input type="date" class="form-control" id="inspection_date"  name="inspection_date" value="@if(isset($surveyDetails->inspection_date)){{$surveyDetails->inspection_date}}@endif">
			    												...
			    												<div class="col-md-12 col-lg-4">
			    													<div class="mb-3 field">
			    														<label for="inspection_remark" class="form-label">Inspection Remark:</label>
			    														<input type="text" class="form-control" id="inspection_remark"  name="inspection_remark" value="@if(isset($surveyDetails->inspection_remark)) {{$surveyDetails->inspection_remark}} @endif">
			    														<p class="error" id="err_inspection_remark"></p>
			    													</div>
			    												</div>
                                                ...
                                                <div class="col-md-12 col-lg-6">
			    												...
			    												<div class="col-md-12 col-lg-4">
			    													<div class="mb-3 field">
			    														...
			    														<input type="text" class="form-control" id="name_of_police_satation"  name="name_of_police_satation" value="@if(isset($surveyDetails->name_of_police_satation)) {{$surveyDetails->name_of_police_satation}} @endif">
			    												...
			    												<div class="col-md-12 col-lg-4">
			    													<div class="mb-3 field">
			    														<div class="row">
			    															<div class="col-md-12 col-lg-2" style="padding:0;">CD's: <input type="radio" value="cd" name="media_type" <?php if (isset($surveyDetails->media_type) && $surveyDetails->media_type == 'cd'){ echo 'checked'; }?>></div>
			    															<div class="col-md-12 col-lg-2" style="padding:0;">Photo: <input type="radio" value="photo" name="media_type" <?php if (isset($surveyDetails->media_type) && $surveyDetails->media_type == 'photo'){ echo 'checked'; }?>></div>
			    															<div class="col-md-12 col-lg-3"><input type="text" name="media_type_value" class="form-control onlyNumericKey" value="@if(isset($surveyDetails->media_type_value)) {{$surveyDetails->media_type_value}} @endif"></div>
				    														</div>
                                          ...
                                          <div class="col-md-12">
                                             <div class="row">
                                             	<div class="col-md-12 col-lg-4">
	    												...
	    												<div class="col-md-12 col-lg-4">
	    													<div class="mb-3 field">
	    														<label for="goods_caried" class="form-label">Weight of Goods caried:</label>
	    														<input type="text" class="form-control" id="goods_caried"  name="goods_caried" value="@if(isset($surveyDetails->goods_caried)) {{$surveyDetails->goods_caried}} @endif">
	    												...
	    												<div class="col-md-12 col-lg-4">
	    													<div class="mb-3 field">
	    														<label for="name_origin_destination" class="form-label">Origin:</label>
	    												...
	    												<div class="col-md-12 col-lg-4">
	    													<div class="mb-3 field">
	    														<label for="ir_invoice_no" class="form-label">L/R Invoice No & Date:</label>
	    														<input type="text" class="form-control" id="ir_invoice_no"  name="ir_invoice_no" value="@if(isset($surveyDetails->ir_invoice_no)) {{$surveyDetails->ir_invoice_no}} @endif">
	    														<p class="error" id="err_ir_invoice_no"></p>
	    													</div>
	    												</div>
                                 ...
                                 <div class="card accordion-item">
                                    ...
                                    <div id="accordionFour" class="accordion-collapse collapse" aria-labelledby="accordionFour" data-bs-parent="#accordionExample" style="">
                                       <div class="accordion-body">
                                          <div class="col-md-12">
                                             <div class="row">
                                             	<div class="col-md-12 col-lg-6">
