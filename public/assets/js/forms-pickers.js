...
! function () {
   ...
   if (e && e.flatpickr({
      ...
      var e = $("#bs-datepicker-basic"),
         ...
         i = $("#bs-datepicker-daterange, .datepicker-daterange"),
         a = $("#bs-datepicker-disabled-days"),
         ...
         i = $("#bs-rangepicker-time"),
         a = $("#bs-rangepicker-range"),
         r = $("#bs-rangepicker-week-num"),
         n = $("#bs-rangepicker-dropdown"),
         o = (e.length && e.daterangepicker({
         ...
         l = $("#timepicker-min-max"),
         e = $("#timepicker-disabled-times"),
         t = $("#timepicker-format"),
         i = $("#timepicker-step"),
         a = $("#timepicker-24hours");
   ...
   function () {
      var e = document.querySelector("#color-picker-classic"),
         ...
         i = document.querySelector("#color-picker-nano");
      e && pickr.create({
         el: e,
         theme: "classic",
